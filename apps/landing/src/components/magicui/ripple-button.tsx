	...
	(
		...
		return (
			<button
				type="button"
				className={cn(
					"relative flex cursor-pointer items-center justify-center overflow-hidden rounded-lg border border-white/20 bg-transparent px-4 py-2 text-center text-white",
					className,
				)}
				onClick={handleClick}
				ref={ref}
