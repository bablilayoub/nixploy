...
sudo bash install.sh`,
			...
			{
				type: "note",
				text: "Nothing about deploys, routing, TLS, backups, previews or the queue changes on the lite profile — it trades history and sampling resolution, never capability.",
			},
