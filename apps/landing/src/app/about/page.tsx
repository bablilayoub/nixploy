		...
		>
			<div className="grid max-w-3xl gap-10 text-[15px] leading-relaxed text-neutral-400">
				<section className="space-y-3">
					<h2 className="text-xl font-semibold tracking-tight text-white">The short version</h2>
					<p>
						...
						<code className="font-mono text-neutral-200">nixploy.yaml</code>, per-service alerts,
						and day-2 ops that do not require opening the dashboard.
					</p>
				</section>
				<section className="space-y-3">
					<h2 className="text-xl font-semibold tracking-tight text-white">What we optimize for</h2>
				...
				<section className="space-y-3">
					<h2 className="text-xl font-semibold tracking-tight text-white">Open source</h2>
					<p>
