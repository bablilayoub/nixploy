...
export const commandRegistry: RegistryEntry[] = [
	...
	// ---------------------------------------------------------------- preview
	{
		...
		options: [
			...
			},
			{
				...
				flag: "--pr <n>",
				description: "Pull request number (PR preview)",
			},
			{
				field: "branch",
				flag: "--branch <name>",
				description: "PR preview only: the head branch to build",
			},
		],
		queuesDeployment: true,
		message: "Preview created; build queued.",
	},
	{
		group: "preview",
		verb: "redeploy",
		procedure: "previewDeployment.redeploy",
		kind: "mutation",
		summary: "Build a preview again from its ref",
		argument: { field: "previewDeploymentId", label: "<previewId>", description: "Preview ID" },
		queuesDeployment: true,
	...
	},
	{
		group: "preview",
		verb: "list-compose",
		procedure: "previewDeployment.list",
		kind: "query",
		summary: "List previews of a compose service",
		argument: { field: "composeId", label: "<composeId>", description: "Compose ID" },
		columns: [
			"previewDeploymentId",
			"kind",
	...
	},
	{
		...
		kind: "query",
		summary: "List previews of an application (pull-request and branch previews)",
		argument: { field: "applicationId", label: "<applicationId>", description: "Application ID" },
		columns: [
			"previewDeploymentId",
			"pullRequestNumber",
	...
	},
	{
		group: "incident",
		verb: "apply",
		procedure: "observability.applyRemediation",
		kind: "mutation",
		summary: "Apply a proposed remediation (the rollback the restart-loop rule suggested)",
		argument: { field: "incidentId", label: "<incidentId>", description: "Incident ID" },
		single: true,
		columns: ["incidentId", "action", "deploymentId"],
	},
	{
		group: "incident",
		verb: "dismiss",
		procedure: "observability.dismissRemediation",
		kind: "mutation",
		summary: "Dismiss a proposed remediation without acting on it",
		argument: { field: "incidentId", label: "<incidentId>", description: "Incident ID" },
