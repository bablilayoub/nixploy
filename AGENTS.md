...
- **Naming other products**: never frame Nixploy as inspired by or derived from another panel. Naming them factually is fine and deliberate — see `apps/landing/src/lib/compare.ts`, whose header carries the rules (link every claim to its source, no claims about their reliability, every page says where they win).
